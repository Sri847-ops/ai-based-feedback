          ...
          <div className="lg:col-span-1">
            <div className="flex items-center mb-4">
              <div className="flex h-20 w-20">
                <img
                  src="/civicpulse_cropped_modern.png"
                  alt="CivicPulse Logo"
                  className="object-contain"
                />
              </div>
              <div>
                <h3 className="text-lg font-bold">CivicPulse</h3>
              </div>
            </div>
            <p className="text-gray-400 text-sm mb-4">
              Empowering citizens to report and track municipal issues for a
              better city infrastructure and services.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <a
                  href="mailto:support@citymunicipality.gov"
                  className="text-gray-400 hover:text-white transition-colors text-sm"
                >
