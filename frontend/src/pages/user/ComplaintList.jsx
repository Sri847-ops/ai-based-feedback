...
import { Search, Filter, Calendar, MapPin, AlertCircle, Eye, Clock, CheckCircle, AlertTriangle } from 'lucide-react';
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500">ID: #{selectedComplaint._id.slice(-6).toUpperCase()}</p>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <h4 className="text-sm font-medium text-gray-700 mb-2">Submitted Date</h4>
                ...
                <div>
                  <h4 className="text-sm font-medium text-gray-700 mb-2">Pincode</h4>
                  ...
                  {selectedComplaint.status !== 'pending' && (
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">Being processed by our team</p>
                      </div>
                    </div>
                  )}
                  {selectedComplaint.status === 'resolved' && (
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">Issue has been addressed</p>
                      </div>
                    </div>
                  )}
                </div>
